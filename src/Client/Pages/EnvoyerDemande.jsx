...
export default function EnvoyerDemande() {
  ...
  return (
    <>
      <div className="w-full h-full flex flex-row gap-14 items-center justify-center">
        ...
        >
          <div className="">
            <div className="border border-dashed border-black flex flex-col px-5 py-5 items-center justify-center gap-2 cursor-pointer">
              <FontAwesomeIcon
                icon={faCloudArrowUp}
              ...
              <span>
                <button
                  className="border-[1px] border-black px-2 py-2 flex flex-row gap-3 items-center bg-SFPETROL rounded-[5px] text-white uppercase"
                  onClick={buttonClick}
                >
